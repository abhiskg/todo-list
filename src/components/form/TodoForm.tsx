...
const TodoForm = ({
  ...
  return (
    ...
    >
      ...
      <button
        className="whitespace-nowrap rounded-md bg-violet-600 px-8 py-3 font-semibold text-white transition-transform duration-200 ease-in-out hover:scale-105 hover:bg-violet-700 active:scale-95  disabled:cursor-not-allowed disabled:bg-red-400 dark:text-gray-900"
        type="submit"
      >
        Add Todo
      </button>
